...
let quantityCard = document.querySelector(".quantity-in-cart");
...
deleteButtons.forEach((button, i) => {
  button.addEventListener("click", function () {
    ...
    quantityCard.textContent = productData.length - products.length;
    quantityCard.textContent !== "0"
      ? quantityCard.classList.remove("visibility-hidden")
      : quantityCard.classList.add("visibility-hidden");
  });
});
